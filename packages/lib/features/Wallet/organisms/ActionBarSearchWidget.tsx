...
export const ActionBarSearchWidget = ({
  searchValue,
  setSearchValue,
  isSearchExpanded,
  onSearchPress,
  ...
  return (
    <Box flexDirection="row" paddingVertical="s" paddingHorizontal="m">
      ...
      <Button
        ...
        paddingHorizontal="m"
        onPress={onTransfer}
        label={isSearchExpanded ? '' : translate('common.transfer')}
        icon={<Convert width={16} height={16} color={colors.textSecondary} />}
      />
    </Box>
  );
};
