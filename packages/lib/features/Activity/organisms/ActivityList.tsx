...
const defaultKeyExtractor = <T,>(item: T, index: number) => {
...
export const ActivityList = <T,>({
  ...
  return listVariant === 'list' ? (
    <FlashList
      ...
      ListEmptyComponent={!hasMore && !loading ? EmptyComponent : undefined}
      ListFooterComponent={loading ? FooterComponent : undefined}
      estimatedItemSize={ActivityItemView.estimatedItemSize || 82}
