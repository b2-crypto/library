...
export const AccountBalance = ({
  ...
  if (direction === 'horizontal') {
    return (
      <View
        ...
        <Text
          variant="subHeadlineReg"
          color="textPrimary"
          accessible
          accessibilityLabel="Total Balance Amount"
          {...testID('totalBalance')}>
  ...
  return (
    <View variant="totalBalance" {...props}>
...
export const AccountBalanceWidget = (props: Omit<Props, 'totalBalance'>) => {
  ...
  return (
    <AccountBalance
      totalBalance={isLoading ? undefined : totalBalance}
      {...props}
    />
  );
};
