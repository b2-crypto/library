...
type Props = { inversed?: boolean; children: ReactNode; logo: ReactNode };

export const ConnectionBound = ({ inversed, children, logo }: Props) => {
  ...
  if (isConnected === false) {
    return (
      <Box flex={1} bg="background2" style={{ paddingTop: top }}>
        {logo}
