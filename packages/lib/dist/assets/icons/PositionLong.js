...
export const PositionLong = (props) => (<Svg width={20} height={20} viewBox="0 0 20 20" fill="none" {...props}>
    <Path d="M1.5 15.5H7L17 4" stroke="#00C938" strokeWidth="2" strokeLinecap="round"/>
