...
import { openPositionsAdapter, useGetMarginPositionHistoryQuery, useLazyGetMarginPositionHistoryQuery, } from '../../../services/marginApi';
import { useMarginAccount } from '../../Margin';
import { createMarginPositionItem } from './createMarginPositionItem';
export const useClosedMarginPositions = (props) => {
    ...
    const { data, originalArgs, isLoading: isPositionsLoading, isUninitialized, refetch, } = useGetMarginPositionHistoryQuery(marginAccount?.AccountId && !isInstrumentsLoading
        ? {
    ...
    const [getClosedPositions] = useLazyGetMarginPositionHistoryQuery();
