...
import { useGetDepositTicketsQuery, useLazyGetDepositTicketsQuery, } from '../../../services/activityApi';
...
export const useDepositTickets = (props) => {
    ...
    const { data, originalArgs, isLoading: isDepositsLoading, isUninitialized, refetch, } = useGetDepositTicketsQuery(currentAccount?.AccountId && !isInstrumentsLoading
        ? {
