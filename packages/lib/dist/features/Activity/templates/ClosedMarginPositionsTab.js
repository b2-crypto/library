...
export const ClosedMarginPositionsTab = ({ depth, instrumentId, onActivityPress, ...listProps }) => {
    const { positions, isRefetching, isLoading, isUninitialized, hasMore, loadMore, refetch, } = useClosedMarginPositions({ depth, instrumentId });
