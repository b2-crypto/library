...
export const VerificationLevelSection = ({ levelData, currentLevel, }) => (<>
    <Box>
    ...
    <Card marginTop="m" marginHorizontal="m" footer={levelData.button}>
      <Box padding="m">
        {levelData?.benefitsVisible && (<Box mb="m">
            <Text variant="bodyBold" mb="s">
              {levelData.level === currentLevel
            ? translate('profile.verification.currentBenefits')
            : translate('profile.verification.addBenefits')}
            </Text>
            <Text color="textSecondary" accessible accessibilityLabel="Benefits" {...testID(`benefits${currentLevel}`)}>
              {levelData.benefitsInfo}
            </Text>
          </Box>)}
        {levelData?.requirementsVisible && (<Box>
            <Text variant="bodyBold" mb="s">
              {translate('common.requirements')}
            </Text>
            <Text color="textSecondary" accessible accessibilityLabel="Requirements" {...testID(`requirements${currentLevel}`)}>
