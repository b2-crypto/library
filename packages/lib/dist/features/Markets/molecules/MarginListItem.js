...
export const MarginListItem = ({ item }) => (<Card flexDirection="row" alignItems="center" padding="m" marginHorizontal="m" marginVertical="s" variant="elevated">
    ...
    <Box flexDirection="row" alignItems="center" flex={1} justifyContent="space-between">
      <Box flexDirection="row" alignItems="flex-start">
        ...
        {item.MarginEnabled && item.MarginInitialRequirement !== 0 && (<Box ml="s" backgroundColor="textSecondary" borderRadius={100} minWidth={21} minHeight={21} alignItems="center" justifyContent="center">
