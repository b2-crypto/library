...
export const AmountSlider = ({ maxQuantity, decimalPlaces }) => {
    ...
    return (<SliderInput value={sliderValue} onChange={onSliderChange} minValue={0} maxValue={100} step={0.1} markers={SLIDER_MARKERS}/>);
};
