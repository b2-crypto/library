...
export const DepositOrWithdrawConfirm = ({ values, onClose, onSubmit, submitting, asset, typeTransaction = 'deposit', }) => {
    ...
    const confirmItems = useMemo(() => [
        ...
        },
        {
            ...
            label: translate(`transaction.${typeTransaction}.confirmAmountLabel`, {
