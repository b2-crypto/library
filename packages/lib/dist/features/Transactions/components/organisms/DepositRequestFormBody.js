...
export const DepositRequestFormBody = ({ asset }) => {
    const { control } = useFormContext();
    return (<Box gap="s">
      <FormInput control={control} name="emailAddress" label={translate('transaction.deposit.emailAddress')}/>
      ...
      <FormInput control={control} name="note" label={translate('transaction.deposit.note')}/>
    </Box>);
};
