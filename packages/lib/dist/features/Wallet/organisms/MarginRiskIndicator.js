...
import { RiskLevel, getActiveSegment, getRiskColorKey, } from '../utils/marginRiskUtils';
const polarToCartesian = (rad, angleInDegrees) => {
...
export const MarginRiskIndicator = ({ riskLevel = { level: RiskLevel.UNKNOWN, riskNumber: 0, label: '--' }, size = 200, }) => {
    ...
    return (<Box alignItems="center" position="relative">
      ...
      <Text style={style.riskAmount} color={riskColorKey} variant="riskIndicator">
