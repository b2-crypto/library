...
export const DepthChart = ({ askData, bidData, backgroundColor, minHeight = 130, ...chartProps }) => {
    const theme = useTheme();
    const { colors, spacing, textVariants: { chartAxisText, chartMarklineText }, } = theme;
