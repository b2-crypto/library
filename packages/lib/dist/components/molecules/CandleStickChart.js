...
export const CandleStickChart = ({ data, width, height, markLineValue, minHeight = 200, ...chartProps }) => {
    ...
    const dataZoom = [
        {
            type: 'inside',
            start: dataXLabel.length > MIN_CHART_ITEMS_COUNT ? DATA_ZOOM_CHART_START : 0,
            end: 100,
        },
        {
    ...
    const itemChartStyle = {
        ...
        color0: hexToRgbA(colors.sellDisabled, 0.3),
