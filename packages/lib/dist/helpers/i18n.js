...
const reactInterpolate = (i, message, options) => {
...
export const translate = memoize(i18n.t.bind(i18n), (key, config) => JSON.stringify(key) +
...
export function setTranslations(languages) {
...
export function getLanguage(lngCode) {
    const lng = lngCode || getDefaultStorage().getString(STORAGE_KEYS.USER_LANGUAGE);
